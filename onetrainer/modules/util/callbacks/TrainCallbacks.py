    ...
    def on_update_train_progress(self, train_progress: TrainProgress, max_sample: int, max_epoch: int):
        try:
            if self.__on_update_train_progress:
                self.__on_update_train_progress(
                    train_progress, max_sample, max_epoch)
        except:
            pass
