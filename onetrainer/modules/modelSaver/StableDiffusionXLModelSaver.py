...
from onetrainer.modules.util.convert.convert_sdxl_diffusers_to_ckpt import convert_sdxl_diffusers_to_ckpt
...
class StableDiffusionXLModelSaver(BaseModelSaver):
    ...
    def save(
        ...
        match output_model_format:
            ...
            case ModelFormat.CKPT:
                self.__save_ckpt(model, model_type,
                                 output_model_destination, dtype)
            case ModelFormat.SAFETENSORS:
                self.__save_safetensors(
                    model, model_type, output_model_destination, dtype)
