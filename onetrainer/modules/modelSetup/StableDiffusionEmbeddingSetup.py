...
from onetrainer.modules.model.StableDiffusionModel import StableDiffusionModel, StableDiffusionModelEmbedding
...
class StableDiffusionEmbeddingSetup(
    ...
    def setup_model(
        ...
        model.text_encoder.get_input_embeddings().to(
        ...
        if len(model.embeddings) == 0:
            ...
            model.embeddings = [
                StableDiffusionModelEmbedding(vector, 'embedding')]

        original_token_embeds, untrainable_token_ids = self._add_embeddings_to_clip(
            model.tokenizer,
            model.text_encoder,
            [(model.embeddings[0].text_encoder_vector,
