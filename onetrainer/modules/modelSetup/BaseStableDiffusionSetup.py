...
from onetrainer.modules.util.dtype_util import create_autocast_context
...
class BaseStableDiffusionSetup(
    ...
    def __init__(self, train_device: torch.device, temp_device: torch.device, debug_mode: bool):
        super(BaseStableDiffusionSetup, self).__init__(
    ...
    def setup_optimizations(
        ...
        if config.gradient_checkpointing:
            ...
            enable_checkpointing_for_clip_encoder_layers(
                model.text_encoder, self.train_device)
    ...
    def __encode_text(
        ...
        text_encoder_output = model.text_encoder(
            tokens, return_dict=True, output_hidden_states=True)
