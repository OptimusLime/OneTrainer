...
from onetrainer.modules.util.convert.convert_stable_cascade_lora_diffusers_to_ckpt import \
...
class WuerstchenLoRAModelSaver(BaseModelSaver):
    ...
    def __save_ckpt(
        ...
        if model.model_type.is_stable_cascade():
            save_state_dict = convert_stable_cascade_lora_diffusers_to_ckpt(
                save_state_dict)
