...
from onetrainer.modules.model.WuerstchenModel import WuerstchenModel, WuerstchenModelEmbedding
...
class WuerstchenEmbeddingSetup(
    ...
    def setup_model(
        ...
        model.prior_text_encoder.get_input_embeddings().to(
        ...
        original_token_embeds, untrainable_token_ids = self._add_embeddings_to_clip(
            model.prior_tokenizer,
            model.prior_text_encoder,
            [(model.embeddings[0].prior_text_encoder_vector,
