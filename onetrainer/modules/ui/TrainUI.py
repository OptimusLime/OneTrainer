...
from onetrainer.modules.ui.ConceptTab import ConceptTab
from onetrainer.modules.ui.ConvertModelUI import ConvertModelUI
from onetrainer.modules.ui.ModelTab import ModelTab
from onetrainer.modules.ui.SampleWindow import SampleWindow
from onetrainer.modules.ui.SamplingTab import SamplingTab
from onetrainer.modules.ui.TopBar import TopBar
from onetrainer.modules.ui.TrainingTab import TrainingTab
...
class TrainUI(ctk.CTk):
    ...
    def bottom_bar(self, master):
        ...
        # training button
        self.training_button = components.button(
            frame, 0, 4, "Start Training", self.start_training)
    ...
    def create_data_tab(self, master):
        ...
        components.switch(master, 0, 1, self.ui_state,
                          "circular_mask_generation")
        ...
        components.switch(master, 1, 1, self.ui_state,
                          "random_rotate_and_crop")
        ...
        components.switch(master, 2, 1, self.ui_state,
    ...
    def create_sampling_tab(self, master):
        ...
        sub_frame = ctk.CTkFrame(
            master=top_frame, corner_radius=0, fg_color="transparent")
        ...
        components.time_entry(top_frame, 0, 1, self.ui_state,
        ...
        components.button(top_frame, 0, 5, "manual sample",
                          self.open_sample_ui)
        ...
        components.switch(sub_frame, 0, 3, self.ui_state,
    ...
    def create_backup_tab(self, master):
        ...
        components.time_entry(master, 0, 1, self.ui_state,
        ...
        components.time_entry(master, 3, 1, self.ui_state,
                              "save_after", "save_after_unit")
    ...
    def lora_tab(self, master):
        ...
        components.file_entry(
            ...
            path_modifier=lambda x: Path(
                x).parent.absolute() if x.endswith(".json") else x
        )
    ...
    def embedding_tab(self, master):
        ...
        components.entry(master, 2, 1, self.ui_state,
                         "embeddings.initial_embedding_text")
    ...
    def __training_thread_function(self):
        ...
        if error_caught:
            self.on_update_status(
                "error: check the console for more information")
        else:
    ...
    def start_training(self):
        if self.training_thread is None:
            ...
            self.training_button.configure(
                text="Stop Training", state="normal")

            self.training_commands = TrainCommands()

            self.training_thread = threading.Thread(
                target=self.__training_thread_function)
