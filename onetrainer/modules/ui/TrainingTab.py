...
from onetrainer.modules.ui.OptimizerParamsWindow import OptimizerParamsWindow
...
from onetrainer.modules.util.optimizer_util import change_optimizer
...
class TrainingTab:
    ...
    def __create_base_frame(self, master, row):
        ...
        components.entry(frame, 3, 1, self.ui_state,
        ...
        components.entry(frame, 7, 1, self.ui_state,
    ...
    def __create_align_prop_frame(self, master, row):
        ...
        components.options(frame, 2, 1, [str(x) for x in list(
            AlignPropLoss)], self.ui_state, "align_prop_loss")
        ...
        components.entry(frame, 5, 1, self.ui_state,
                         "align_prop_truncate_steps")
    ...
    def __create_text_encoder_frame(self, master, row):
        ...
        components.entry(frame, 2, 1, self.ui_state,
    ...
    def __create_unet_frame(self, master, row):
        ...
        components.switch(frame, 3, 1, self.ui_state,
    ...
    def __create_noise_frame(self, master, row):
        ...
        components.entry(frame, 1, 1, self.ui_state,
    ...
    def __create_loss_frame(self, master, row, supports_vb_loss: bool):
        ...
        components.options(frame, 4, 1, [str(x) for x in list(
            LossScaler)], self.ui_state, "loss_scaler")

    def __open_optimizer_params_window(self):
        window = OptimizerParamsWindow(
            self.master, self.train_config, self.ui_state)
