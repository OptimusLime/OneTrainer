    ...
    def __sample_base(
        ...
        with self.model.autocast_context:
            ...
            noise_scheduler = create.create_noise_scheduler(
                noise_scheduler, self.pipeline.scheduler, diffusion_steps)
            ...
            combined_prompt_attention_mask = torch.cat(
                [negative_tokens_attention_mask, tokens_attention_mask])
            ...
            for i, timestep in enumerate(tqdm(timesteps, desc="sampling")):
                ...
                if cfg_rescale > 0.0:
                    ...
                    noise_pred_rescaled = noise_pred * \
                        (std_positive / std_pred)
                    noise_pred = (
