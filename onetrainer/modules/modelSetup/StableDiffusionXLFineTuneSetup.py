        ...
        if config.text_encoder.train:
            param_groups.append(
                self.create_param_groups(
                    config, model.text_encoder_1.parameters(), config.text_encoder.learning_rate)
            )

        if config.text_encoder_2.train:
            param_groups.append(
                self.create_param_groups(
                    config, model.text_encoder_2.parameters(), config.text_encoder_2.learning_rate)
            )

        if config.unet.train:
            param_groups.append(
                self.create_param_groups(
                    config, model.unet.parameters(), config.unet.learning_rate)
            )
