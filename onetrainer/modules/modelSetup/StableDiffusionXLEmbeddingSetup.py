...
from onetrainer.modules.model.StableDiffusionXLModel import StableDiffusionXLModel, StableDiffusionXLModelEmbedding
from onetrainer.modules.modelSetup.BaseStableDiffusionXLSetup import BaseStableDiffusionXLSetup
from onetrainer.modules.modelSetup.mixin.ModelSetupClipEmbeddingMixin import ModelSetupClipEmbeddingMixin
...
class StableDiffusionXLEmbeddingSetup(
    ...
    def setup_model(
        ...
        model.text_encoder_1.get_input_embeddings().to(
            dtype=config.embedding_weight_dtype.torch_dtype())
        model.text_encoder_2.get_input_embeddings().to(
            dtype=config.embedding_weight_dtype.torch_dtype())
        ...
        original_token_embeds_2, untrainable_token_ids_2 = self._add_embeddings_to_clip(
            model.tokenizer_2,
            model.text_encoder_2,
            [(model.embeddings[0].text_encoder_2_vector,
              model.embeddings[0].text_tokens)],
        )
