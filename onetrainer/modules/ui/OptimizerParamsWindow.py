...
from onetrainer.modules.util.optimizer_util import OPTIMIZER_DEFAULT_PARAMETERS, update_optimizer_config, load_optimizer_defaults, \
    change_optimizer
...
class OptimizerParamsWindow(ctk.CTkToplevel):
    ...
    def create_dynamic_ui(
        ...
        KEY_DETAIL_MAP = {
            ...
            'fused': {'title': 'Fused', 'tooltip': 'Whether to use a optimizer_fused implementation if available.', 'type': 'bool'},
