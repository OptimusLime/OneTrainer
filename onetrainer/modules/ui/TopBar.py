...
class TopBar:
    ...
    def __save_new_config(self, name):
        ...
        if self.config_ui_data["config_name"] != path_util.canonical_join(self.dir, f"{name}.json"):
            self.config_ui_state.get_var("config_name").set(
                path_util.canonical_join(self.dir, f"{name}.json"))
    ...
    def __load_current_config(self, filename):
        try:
            ...
            is_built_in_preset = basename.startswith(
                "#") and basename != "#.json"
            ...
            with open(filename, "r") as f:
                ...
                loaded_config = default_config.from_dict(
                    loaded_dict).to_unpacked_config()
